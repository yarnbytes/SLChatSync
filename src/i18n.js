    ...
    zh: {
        app: {
            ...
            form: {
                ...
                repoPlaceholder: 'https://gitee.com/user/sl-logs.git',
                userLabel: 'Git 平台用户名',
                userPlaceholder: '登录账号 (例如: yarnbyte)',
                tokenLabel: '访问令牌 Token 或 密码',
                tokenPlaceholder: '••••••••••••••••',
                encryptLabel: '聊天记录加密密码 (可选)',
                encryptHelp: '端到端加密密码 (可选，保卫隐私)',
                encryptPlaceholder: '设置后，传到云端的数据将全是乱码'
            },
            logs: {
                fillInfo: '❌ 请完整填写设置信息',
                start: '🚀 开始同步聊天记录...',
    ...
    en: {
        app: {
            ...
            form: {
                ...
                repoPlaceholder: 'https://github.com/user/sl-logs.git',
                userLabel: 'Git Platform Username',
                userPlaceholder: 'Login username (e.g., yarnbyte)',
